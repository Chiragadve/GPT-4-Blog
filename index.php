...
<body>
  ...
  <section class="container popular-tags-section">
    ...
    <ul class="tags-container">
      <a href="https://chatgpt.com/g/g-HxPrv1p8v-code-tutor" target="_blank" class="tag-item">
        <img src="./assets/code tutor.png" alt="Code Tutor Logo" />
        Tutor GPT
      </a>
      <a href="https://chatgpt.com/g/g-9YeZz6m6k-math-solver" target="_blank" class="tag-item">
        <img src="./assets/math-solver-logo.png" alt="Math Solver Logo" />
        Math GPT
      </a>
      <a href="https://chatgpt.com/g/g-kZ0eYXlJe-scholar-gpt" target="_blank" class="tag-item">
        <img src="./assets/scholar-gpt-logo.webp" alt="Scholar GPT Logo" />
        Scholar
      </a>
      <a href="https://chatgpt.com/g/g-alKfVrz9K-canva" target="_blank" class="tag-item">
        <img src="./assets/canva.png" alt="Canva Logo" />
        Canva
      </a>
      <a href="https://chatgpt.com/g/g-bo0FiWLY7-consensus" target="_blank" class="tag-item">
        <img src="./assets/consensus.png" alt="Consensus Logo" />
        Consensus
      </a>
      <a href="https://chatgpt.com/g/g-2DQzU5UZl-code-copilot" target="_blank" class="tag-item">
        <img src="./assets/copilot.png" alt="Copilot Logo" />
        Copilot
      </a>
      <a href="https://chatgpt.com/g/g-5QhhdsfDj-diagrams-show-me-for-presentations-code-excel" target="_blank" class="tag-item">
        <img src="./assets/diagram.jpg" alt="Diagram Logo" />
        Diagram
      </a>
      <a href="https://chatgpt.com/g/g-cKXjWStaE-python" target="_blank" class="tag-item">
        <img src="./assets/python.png" alt="Python Logo" />
        Python
      </a>
      <a href="https://chatgpt.com/g/g-Hkqnd7mFT-video-gpt-by-veed" target="_blank" class="tag-item">
        <img src="./assets/veed.png" alt="Video GPT Logo" />
        Video
      </a>
      <a href="https://chatgpt.com/g/g-Ji2QOyMml-copywriter-gpt-marketing-branding-ads" target="_blank" class="tag-item">
        <img src="./assets/copyrighter.jpeg" alt="Copywriter GPT Logo" />
        Copyrighter
      </a>
      <a href="https://chatgpt.com/g/g-R6VqLNHFM-excel-ai" target="_blank" class="tag-item">
        <img src="./assets/excel.jpeg" alt="Excel AI Logo" />
        Excel
      </a>
      <a href="https://chatgpt.com/g/g-O5mNWQGMa-market-research-and-competitive-analysis-gpt" target="_blank" class="tag-item">
  ...
  <section id="featured" class="container editors-picked">
    ...
    <div class="editor-container flex">
      ...
      <div class="card big-card">
        ...
        <div class="card-content">
          ...
          <div class="card-author">
            <img class="user-circle" src="./assets/plantly.png" alt="Author" />
            <span>Chirag</span>
    ...
    <div class="lower-card-section">
      <div class="editor-container flex">
        <div class="card small-card">
          ...
          <div class="card-content">
            ...
            <div class="card-author">
              <img class="user-circle" src="./assets/images.jpeg" alt="Author" />
              <span>Joseph</span>
            </div>
          </div>
        </div>
      ...
      <div class="editor-container flex">
        <div class="card small-card">
          <img src="./assets/seo.png" alt="Self-observation" />
          <div class="card-content">
            <div class="card-title">
      ...
      <div class="latest-post-container">
        ...
        <span class="latest-post-right">
          ...
          <div class="author-info">
            <img src="./assets/images.jpeg" width="10px" alt="">
            <p>Joseph</p>
          </div>
        </span>
      </div>
  ...
  <section id="contactus" class="contact-us">
    <div class="container contain-contact">
      <div class="contact-form">
        ...
        <form>
          ...
          <div class="input-group">
            ...
            <input type="tel" placeholder="Phone no." class="input-field" />
          </div>
      ...
      <!-- <div class="image-container">
          <img src="assets/contactus.png" alt="Programmer Illustration" />
        </div> -->
    </div>
  </section>
    ...
    <div class="container">
      <div class="footer-section">
        ...
        <div class="footer-section-content flex">
          <p class="about-company">GPT-4 Blog is not only a blog but a mission to educate people on making their life easier with chatgpt</p>
